			...
			property: function property(customController) {
				...
				function play3DObject(value) {
					if (buttons.buttonPlay.innerHTML === lang.playSymbol) {
						...
						group.userData.timerId = setInterval(playNext, 1000 / (customController.controller === undefined ? 1 : customController.controller.getValue()));
					} else pause();
				}
				_play = play3DObject;
...
//# sourceMappingURL=controllerPlay.js.map
